          ...
          <div className="relative bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-8 border border-white/20">
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                {/* Results Section */}
                <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-6 border border-white/60">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-lg blur transition-all opacity-0 group-hover:opacity-100" />
